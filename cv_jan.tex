...
% left bottom right top
  \adjustbox{clip, trim={1cm 2cm 0.3cm 0.3cm, height=\photoH,
    keepaspectratio}}{\includegraphics[width=\linewidth]{cv-pic.jpeg}}
% \includegraphics[height=\photoH, width=\linewidth, keepaspectratio, trim={1cm 1cm 0 0}, clip]{cv-pic.jpeg}
\end{minipage}
...
\cventry{Seit 10/2023}{WHF, UDE Lehrstuhl Mathematik}{%
\begin{itemize}
...
\cventry{-}{Teilnahme am Buddy-Programm}{%
}
